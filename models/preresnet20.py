...
class PreActResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, initial_channels, num_classes, per_img_std=False, stride=1):
        ...
        self.linear = nn.Linear(initial_channels * 4 * block.expansion, num_classes)
...
def preactresnet20(num_classes=10, dropout=False, per_img_std=False, stride=1):
    model = PreActResNet(PreActBlock, [3, 3, 3], 16, num_classes, per_img_std, stride=stride)
    return model
